...
class MainWindow(QMainWindow):
    ...
    def create_ui_components(self):
        ...
        self.button_left.setAutoRepeat(True)
        self.button_left.setAutoRepeatDelay(300)
        self.button_left.setAutoRepeatInterval(100)
        self.button_up = QPushButton("▲")
        self.button_up.clicked.connect(self.move_up)
        self.button_up.setAutoRepeat(True)
        self.button_up.setAutoRepeatDelay(300)
        self.button_up.setAutoRepeatInterval(100)
        self.button_right = QPushButton("►")
        self.button_right.clicked.connect(self.move_right)
        self.button_right.setAutoRepeat(True)
        self.button_right.setAutoRepeatDelay(300)
        self.button_right.setAutoRepeatInterval(100)
        self.button_down = QPushButton("▼")
        self.button_down.clicked.connect(self.move_down)
        self.button_down.setAutoRepeat(True)
        self.button_down.setAutoRepeatDelay(300)
        self.button_down.setAutoRepeatInterval(100)
